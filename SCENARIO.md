...
# Публичный ключ ~/.ssh/id_ed25519.pub добавится на VM автоматически через cloud-init
```

> **Важно:** путь к ключу `~/.ssh/id_ed25519` используется во всех командах Ansible. Если вы создали ключ с другим именем — замените в командах.
